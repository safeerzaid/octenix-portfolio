    ...
    >
      ...
      >
        ...
        >
          <a
            href="#home"
            className={`flex items-center gap-0.5 no-underline shrink-0 pointer-events-auto transition-opacity duration-300 ${open ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}
            onClick={(e) => {
        ...
        >
          <div className="sm-panel-inner flex-1 flex flex-col gap-5">
                ...
                items.map((it, idx) => (
                  <li className="sm-panel-itemWrap relative overflow-hidden leading-none" key={it.label + idx}>
                    <a
                      ...
                      data-index={idx + 1}
                      onClick={() => setTimeout(closeMenu, 400)}
                    >
            ...
            {displaySocials && socialItems && socialItems.length > 0 && (
              <div className="sm-socials mt-auto mb-12 pb-2 flex flex-col gap-3 md:hidden" aria-label="Social links">
...
.sm-scope .sm-socials { margin-top: auto; margin-bottom: 3.5rem; padding-top: 1rem; display: flex; flex-direction: column; gap: 0.75rem; }
